...
export class Setting {
  ...
  public static get BGMVolume(): number {
    return this.settings.game.sound.bgm;
  }
  ...
  public static get BGSVolume(): number {
    return this.settings.game.sound.bgs;
  }
  ...
  public static get SEVolume(): number {
    return this.settings.game.sound.se;
  }
  ...
  public static get VoiceVolume(): number {
    return this.settings.game.sound.voice;
  }
